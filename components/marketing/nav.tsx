...
const MENUS: { label: string; href?: string; cols?: 1 | 2; items?: MenuItem[] }[] = [
  ...
  },
  {
    ...
    cols: 2,
    items: [
      { icon: Code2, label: "Software development", desc: "Track bugs, ship releases, skip the status meetings.", href: "/#use-cases" },
      { icon: Megaphone, label: "Marketing", desc: "Plan campaigns, manage creative workflows, and launch on time.", href: "/#use-cases" },
      { icon: ClipboardList, label: "Project management", desc: "Manage requests, track incidents, and keep operations running smoothly.", href: "/#use-cases" },
      { icon: Server, label: "IT", desc: "Coordinate timelines, track deliverables, and ship projects across any team.", href: "/#use-cases" },
    ],
  },
  {
    label: "Resources",
    cols: 1,
    items: [
      { icon: FileText, label: "Help center", desc: "Guides & answers", href: "/app/help" },
      { icon: BarChart3, label: "Customers", desc: "Stories from teams", href: "/#testimonials" },
      { icon: ShieldCheck, label: "Security", desc: "Trust & compliance", href: "/#security" },
      { icon: Users, label: "Pricing", desc: "Plans for every team", href: "/pricing" },
    ],
  },
